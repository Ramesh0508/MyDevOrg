...
export default class ScenarioEight extends LightningElement {
    ...
    handletotalBill() {
        try{
        this.totalBill = Number(this.item1Quantity) * Number(this.item1Price) +
        Number(this.item2Quantity) * Number(this.item2Price) +
